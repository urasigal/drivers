...
//	}
	...
	public double getPSNR(String pathToRefFrame, String pathToTestdFrame) {
		Mat I1 = imread(pathToRefFrame);
		Mat I2 = imread(pathToTestdFrame);
		Mat s1 = new Mat();
	...
	public static Scalar getMSSIM(String pathToRefFrame, String pathToTestdFrame) {
		try {
		Mat i1 = imread(pathToRefFrame);
		Mat i2 = imread(pathToTestdFrame);
