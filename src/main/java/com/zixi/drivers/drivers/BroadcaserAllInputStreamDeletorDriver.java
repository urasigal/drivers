...
public class BroadcaserAllInputStreamDeletorDriver extends BroadcasterLoggableApiWorker
{
	...
	public DriverReslut testIMPL(String login_ip, String userName, String userPassword, String uiport) throws Exception
	{
		...
		for(int i = 0; i < taskNumbers; i ++)
		{
			...
			BroadcasterSingleCallableInputStreamDeletionDriver broadcasterSingleCallableInputStreamDeletionDriver = new BroadcasterSingleCallableInputStreamDeletionDriver(tmpParams);
			
			callablesTasks.add(broadcasterSingleCallableInputStreamDeletionDriver);
		}
