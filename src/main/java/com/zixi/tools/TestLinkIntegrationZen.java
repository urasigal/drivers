...
public class TestLinkIntegrationZen{
    ...
    public ArrayList<Integer> getTestcaseByTestplanId(int testPlanID) throws TestLinkAPIException, MalformedURLException 
	{
            ...
            throws TestLinkAPIException, MalformedURLException 
    {
        ...
        Integer.parseInt(testcaseId), null, 8597, status, buildNumber, null,
    ...
    {
    	 TestLinkAPI testlinkAPIClient = new TestLinkAPI(new URL(url), devKey);
    	 int buildId = testlinkAPIClient.createBuild(8597, build, "").getId();
    	 return buildId;
    }
    ...
    public StringBuilder getTestInfo(int testID) throws TestLinkAPIException, MalformedURLException
    {
    	 ...
    	 Build 				lastBuild 				= 	testlinkAPIClient.getLatestBuildForTestPlan(8597);
    ...
    public static void main(String[] args) throws TestLinkAPIException, MalformedURLException {
    	...
    	TestlinkIntegration.getTestInfo(8597);
	}
}
