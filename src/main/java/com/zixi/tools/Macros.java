...
public class Macros {
		...
		public static final int SYS_CPU 				= 100;
		public static final int GET_ALL_STREAMS 		= 17;
		//////////////////////////////////////////////////
		
		public static final String GOOD = "GOOD";
		public static final String BAD =  "BAD";
		public static final int TEST_ATTEMPT_QUNTYTY 	= 10;
		...
		public static final String BAD_BITRATE 			= "On of the bit rate API probing showed zero bit rete";
		public static final String HIGH_JITTER 			= "The jitter was high than 300";
		
		public static final String ZAPI_EXECUTION 		= "/public/rest/api/1.0/execution";
		public static final String ZAPI_CYCLE			= "/public/rest/api/1.0/cycle";
		public static final String ZAPI_FOLDERS         = "/public/rest/api/1.0/folders";
		public static final String ZAPI_SEARCH_CYCLE	= "/public/rest/api/1.0/cycles/search";
		public static final String ZAPI_ATTACHMENT		= "/public/rest/api/1.0/attachment";
