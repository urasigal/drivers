...
public class BroadcasterMultiplePushDriver  extends BroadcasterLoggableApiWorker implements TestDriver{
	...
	{	
		...
		driverReslut = new DriverReslut(zthreadPool.zexecutePush());
	...
	{	
		...
		driverReslut = new DriverReslut(zthreadPool.zexecutePushManual());
		
		return driverReslut;
	}
	
	public DriverReslut testIMPLManualDiffPorts(String... args) throws InterruptedException, ExecutionException
	{	
		// Pass parameters to arrayList in order to provide them to ZthreadPool.
		ArrayList<String> parameters = new ArrayList<String>(Arrays.asList(args));
		...
		driverReslut = new DriverReslut(zthreadPool.zexecutePushManualDiffPorts());
